 ...
 * @param[in]     bits  The number of bits per frame
 * @param[in]     mode  The SPI mode (clock polarity, phase, and shift direction)
 * @param[in]     Order  MSB/LSB order <Not supported>
 */
#warning "The MSB data bit is always sent first in SPI master or slave mode"
void spi_format(spi_t *obj, int bits, int mode, spi_bitorder_t order/*not supported*/)
{
 ...
 * @param[in] hint      A suggestion for how to use DMA with this transfer  <Only DMA mode of Async supported>
 */
